...
//
//func New(dag *dag.DAG, log global.Logging) *PrunerOld {
//	return &PrunerOld{
//		DAG:     dag,
...
//}
//
//func (p *PrunerOld) Start(ctx context.Context, doneOnClose *sync.WaitGroup) {
//	go func() {
//		p.mainLoop(ctx)
//		doneOnClose.Done()
...
//func (p *PrunerOld) pruneBranches(verticesDescending []*vertex.WrappedTx, pruneBaselineSlot ledger.Slot, pruneDeadline time.Time) (ret int) {
//	for _, vid := range verticesDescending {
...
//
//func (p *PrunerOld) mainLoop(ctx context.Context) {
//	for {
//		select {
//		case <-ctx.Done():
//			return
