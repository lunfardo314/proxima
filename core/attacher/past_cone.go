...
func (a *attacher) attachInputs(v *vertex.Vertex, vid *vertex.WrappedTx, parasiticChainHorizon ledger.LogicalTime, visited set.Set[*vertex.WrappedTx]) (ok bool) {
...
func (a *attacher) attachRooted(wOut vertex.WrappedOutput, consumerTxID *ledger.TransactionID) (ok bool, isRooted bool) {
...
func (a *attacher) attachOutput(wOut vertex.WrappedOutput, consumerTxID *ledger.TransactionID, parasiticChainHorizon ledger.LogicalTime, visited set.Set[*vertex.WrappedTx]) bool {
