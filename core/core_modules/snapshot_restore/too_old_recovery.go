...
func checkStateTooOldDownload(log global.Logging) (string, error) {
	...
	// still on canonical — is kept here and re-anchored at runtime. See kb/archive/incidents/fork_detection_recovery.md §2b.
...
func latestCommittedSlotAndTTLInDB(dbPath string) (slot, ttl uint32, ok bool) {
	...
	// irrelevant here). See kb/archive/shipped/txid_ttl_tiered.md.
