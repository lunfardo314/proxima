...
func (b *Branches) _commitPendingBranchUnlocked(branchID base.TransactionID, pb *PendingBranchCommit, baselineRoot common.VCommitment) *multistate.Updatable {
	...
	// tiered by branch flag (kb/archive/shipped/txid_ttl_tiered.md): non-branch records are pruned at a short
	...
	// PrunableTxIDsAtSlot doesn't pay full cold-cache I/O each time. See kb/archive/incidents/trie_iteration.md §2.a.
...
// kb/archive/shipped/txid_ttl_tiered.md.
