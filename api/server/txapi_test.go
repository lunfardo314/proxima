...
func TestGetParsedTransaction(t *testing.T) {
	...
	assert.True(t, ret.TotalAmount > ledger.DefaultInitialSupply-1-ledger.GenesisMineChainDust)
...
func TestGetVertexDep(t *testing.T) {
	...
	assert.EqualValues(t, ledger.DefaultInitialSupply-1-ledger.GenesisMineChainDust+ret.TotalInflation, ret.TotalAmount)
