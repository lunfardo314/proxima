...
type (
	...
	// []ledger.OutputWithID. See kb/archive/shipped/get_outputs.md.
	...
	// Computed server-side and cached (lazily refreshed). See kb/archive/shipped/network_rtt_mapping.md.
