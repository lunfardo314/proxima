...
//func (ut *utangle_new.UTXOTangle) GetWrappedOutput(oid *core.OutputID, baselineState ...multistate.SugaredStateReader) (WrappedOutput, bool, bool) {
//	ut.mutex.Lock()
...
//func (ut *utangle_new.UTXOTangle) _pickFromExistingVertex(oid *core.OutputID, baselineState ...multistate.SugaredStateReader) (WrappedOutput, bool, bool) {
//	txid := oid.TransactionID()
...
//}
//
//func (ut *utangle_new.UTXOTangle) _wrapNewIntoExistingVirtualBranch(vid *WrappedTx, oid *core.OutputID) (WrappedOutput, bool, bool) {
...
//}
//
//func (ut *utangle_new.UTXOTangle) _fetchAndWrapBranch(oid *core.OutputID) (WrappedOutput, bool, bool) {
...
//	vt := utangle_new.NewVirtualBranchTx(&bd)
