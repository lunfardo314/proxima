...
func (vid *WrappedTx) BaseStemOutput(ut *utangle_new.UTXOTangle) *WrappedOutput {
...
func (vid *WrappedTx) CoverageDelta(ut *utangle_new.UTXOTangle) (*core.TransactionID, uint64) {
	if ut == nil {
		// TODO temporary
		return nil, 0
	}
	...
	if ret > coverageCap {
		...
		utangle_new.SaveGraphPastCone(vid, "failed_coverage")
