...
// cross the GC horizon). See kb/archive/shipped/txid_ttl_tiered.md.
...
// cross the branch GC horizon to exercise branch + RootRecord pruning). See kb/archive/shipped/txid_ttl_tiered.md.
