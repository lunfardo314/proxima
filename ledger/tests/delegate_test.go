...
//
//  3. Epoch parameters (kb/archive/shipped/delegation_epoch_params.md) — bounds at the
...
//     (kb/archive/shipped/delegation_allowance.md).
//
...
// Per Option C of kb/archive/shipped/delegation_epoch_params.md the state must
