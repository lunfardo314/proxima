...
//
// See kb/archive/shipped/native_token.md for the design rationale.
package ledger
...
// constraint. See kb/archive/shipped/native_token.md §4.
//
// Fixed-arity 2:
...
// output are permitted. See kb/archive/shipped/native_token.md §3.
...
// kb/archive/shipped/native_token.md §3; duplicate (controller, tag) pairs are
