...
func DefaultIdentityParameters(privateKey ed25519.PrivateKey, genesisTimeUnix uint32, description ...string) *IdentityParameters {
	...
	return &IdentityParameters{
		...
		MinimumInflatableAmount0:     DefaultInitialSupply / DefaultSlotInflationBase,
...
func (id *IdentityParameters) Lines(prefix ...string) *lines.Lines {
	...
	return lines.New(prefix...).
		...
		Add("Slot inflation fraction: %s", util.Th(id.MinimumInflatableAmount0)).
...
functions:
   ...
   -
      ...
      source: 5
   - 
      sym: slotInflationFraction
      description: auxiliarly inflation constant
      source: div(constInitialSupply, constSlotInflationBase)
   - 
      sym: chainInflation
      description: calculates inflation generated by amount $0 in slot $1 during the period of $2 slots
      source: mul($2,div($0,add(slotInflationFraction,$1)))
   - 
      sym: chainInflationOneSlot
      description: calculates one-slot inflation in slot $0 of amount $1
      source: chainInflation($0,$1, u64/1)
`
