...
See [`kb/archive/shipped/wasm_txbuilder.md`](../../../kb/archive/shipped/wasm_txbuilder.md) for the
...
- [`kb/archive/shipped/wasm_txbuilder.md`](../../../kb/archive/shipped/wasm_txbuilder.md) — the
  txbuildercore refactor spec (Phases 0–6 shipped).
- [`kb/archive/shipped/wasm_txbuilder_helpers.md`](../../../kb/archive/shipped/wasm_txbuilder_helpers.md)
  — the wallet-helper inventory.
- [`kb/archive/shipped/wasm_easyfl.md`](../../../kb/archive/shipped/wasm_easyfl.md) — the
