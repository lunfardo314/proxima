...
func (lib *Library) ChainInflationDirect(amount uint64, inSlot, forSlots uint32) uint64 {
...
func (lib *Library) ChainInflationOneSlotDirect(amount uint64, inSlot uint32) uint64 {
	return lib.ChainInflationDirect(amount, inSlot, 1)
}
