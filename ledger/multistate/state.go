...
type (
	...
	// metadata-refactor (see kb/archive/shipped/metadata-refactor.md §5), it carries only
...
// The two kinds have different retention horizons (see kb/archive/shipped/txid_ttl_tiered.md).
...
func (u *Updatable) updateUTXOLedgerDB(updateFun func(updatable *immutable.TrieUpdatable) error, rootRecordsParams *RootRecordParams, deleteBranchRootRecords []base.TransactionID) error {
	...
	// record and the flat-KV RootRecord never diverge (see kb/archive/shipped/txid_ttl_tiered.md §2a).
