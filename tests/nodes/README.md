...
The genesis state contains the initial supply of tokens `1.000.000.000.000.000` in the bootstrap sequencer output (minus 1 token which goes to the controller's mote output),
