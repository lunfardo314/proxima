...
> **SHIPPED** — spec 0 for the monitor page: what it shows and where each number
> comes from. `api/monitor/` (`9996b0f2`) implements it, in three freshness tiers
> with per-section as-of stamps, and serves live on the testnet. **The code is the
> truth**; this records what the page was meant to show and where each number was
> meant to come from. Spec 1 was never written — the prototype answered the
> open questions directly, and section 8 records what it settled. Archived
> 2026-09-03.
