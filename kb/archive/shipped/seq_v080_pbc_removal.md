...
Date: 2026-04-30
Branch: `develop08`
Driver: ship the Phase L items from `kb/archive/shipped/seq-improvements.md` permanently into the ledger and the node code, without changing observable sequencer behavior.
...
- `kb/archive/shipped/seq-improvements.md` "Phase L items" can be marked done in a
