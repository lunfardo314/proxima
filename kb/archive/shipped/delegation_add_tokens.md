...
`kb/research/delegation_scalability.md`, which establishes why this matters: delegation count
...
something consumes it (`kb/research/delegation_scalability.md` §3). Topping up is such a
...
- it spreads delegations over sequencers without coordination, which is what the per-epoch
  cap needs (`kb/research/delegation_scalability.md` §6);
