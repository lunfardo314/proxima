...
- `kb/archive/shipped/dex_orders.md` — the `ORDR` precedent this generalizes.
- `kb/archive/shipped/chain_explorer.md` — primary consumer (kind filter).
- `kb/archive/shipped/native_token.md` — foundry / `holderID || tag` compound index.
