...
> **RESOLVED** — diagnosed 2026-08-26 on the testnet,
> fixed the same day (`3ecdb614`). The fleet restarted onto a fresh genesis on
> 2026-09-03; four hours in, all 24 delegations are frozen — delegated capital
> and frozen coverage are equal to the mote — and consensus health is 7/12 with
> all five sequencers consolidating. The symptom has not recurred. That is a
> young network with a small delegation population, so it is the absence of the
> failure rather than a test of the fix at scale.
