...
>
> Companion: [`kb/research/state_scan_paging.md`](research/state_scan_paging.md) — the paged /
...
[`kb/research/state_scan_paging.md`](research/state_scan_paging.md). Compaction is specified to
...
- **Paged / cursored state scan** — [`state_scan_paging.md`](research/state_scan_paging.md).
