...
func NewUTXODB(trace ...bool) *UTXODB {
	...
	initLedgerParams := genesis.IdentityData{
...
func (u *UTXODB) StateIdentityData() *genesis.IdentityData {
	return genesis.MustIdentityDataFromBytes(u.StateReader().StateIdentityBytes())
}
